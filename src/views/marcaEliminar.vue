...
const marcaDelete = ref([]);


const nombreMarca = ref('')
const origenMarca = ref('')
...
onMounted( async () => {
   await getFilterMarcaDelete();
  
   nombreMarca.value = marcaDelete.value.nombre
    origenMarca.value = marcaDelete.value.id_linea
    user_creaMarca.value = marcaDelete.value.user_crea
    Fec_CreaMarca.value = marcaDelete.value.fec_crea
});
        ...
        <div class="dash-content">
            <div class="contenedorDelete">
              <div class="card">
                ...
                <p class="message">
                  <span>Nombre: </span>{{ nombreMarca }}
                </p>
        
                <p class="message">
                  <span>Origen: </span>{{ origenMarca }}
                </p>
                <p class="message">
                ...
                <div class="actions">
                  <button @click="eliminarM()" class="read">
                    Eliminar
                  </button>
                  <router-link class="mark-as-read" to="/marcas">
                      volver           
                  </router-link>
                </div>
            </div>
