...
onMounted( async () => {
   ...
   await getFilterTamCapDelete();
  
    id_tipoD.value = tamCapDelele.value.id_tipo
    nombreD.value = tamCapDelele.value.nombre
    user_creaD.value = tamCapDelele.value.user_crea
    user_modD.value = tamCapDelele.value.user_mod
    fec_creaD.value = tamCapDelele.value.fec_crea
});
        ...
        <div class="dash-content">
            <div class="contenedorDelete">
              <div class="card">
                ...
                <p class="message">
                  <span>Tipo de Articulo: </span>{{ id_tipoD }}
                </p>
                <p class="message">
                  <span>Tamaño: </span>{{nombreD}}
                </p>
                <p class="message">
                  <span>Investigador: </span>{{ user_creaD }}
                </p>
                <p class="message">
                  <span>Modicado por: </span>{{ user_modD }}
                </p>
                <p class="message">
                  <span>Fecha: </span>{{ fec_creaD }}
                </p>
                ...
                <div class="actions">
                  ...
                  <router-link class="mark-as-read" to="/tamCap">
                      volver           
                  </router-link>
                </div>
            </div>
