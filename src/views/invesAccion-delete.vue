...
onMounted( async () => {
   ...
   fechaInves.value = investigacionDelele.value.fecha
   id_tiendaInves.value = investigacionDelele.value.id_tienda
    motivoInves.value = investigacionDelele.value.motivo
    investigadorInves.value = investigacionDelele.value.investigador
    user_creaInves.value = investigacionDelele.value.user_crea
    user_modInves.value = investigacionDelele.value.user_mod
});
        ...
        <div class="dash-content">
            <div class="contenedorDelete">
              <div class="card">
                ...
                <p class="message">
                  <span>Tienda: </span>{{ id_tiendaInves }}
                </p>
                <p class="message">
                  <span>Motivo: </span>{{motivoInves}}
                </p>
                <p class="message">
                  <span>Investigador: </span>{{ investigadorInves }}
                </p>
                <p class="message">
                  <span>Usuario: </span>{{ user_creaInves }}
                </p>
                <p class="message">
                  <span>UsuarioMod: </span>{{ user_modInves }}
                </p>
                <p class="message">
                  <span>Fecha de Creacion: </span>{{ fechaInves }}
                </p>
