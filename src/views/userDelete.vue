...
async function getFilterInvesDelete() {
    try {
        ...
        createdAt.value = response.data[0].createdAt
        user_crea.value = response.data[0].user_crea
        ...
        <div class="dash-content">
            <div class="contenedorDelete">
                <div class="card">
                    ...
                    <p class="message">
                        <span>Permisos de usuario: </span>{{ rol }}
                    </p>
                    <p class="message">
                        <span>Fecha de Creacion: </span>{{ createdAt }}
                    </p>
                    ...
                    <div class="actions">
                        ...
                        <router-link class="mark-as-read" to="/usuario">
                            volver           
                        </router-link>
                    </div>
                </div>
