...
const columns = ref([
    ...
    <i class="ri-edit-2-line edit-table" onclick="location.href='/modeloEdit/${data}';"></i>`},

    {data:'id', render: (data,type,row,meta,) => `
    <i class="ri-delete-bin-5-line delete-table" onclick="location.href='/modeloDelete/${data}';"></i>`},                         
]);
